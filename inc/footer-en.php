...
?>
    ...
    <div class="cd-footer">
      <div class="cd-footer-left">
        <div class="cd-footer-logo">
          <a href="index-en.php">
            <img src="img/logo-tenuta-orsumella-tenuta-orsumella-footer.png" alt="logo Tenuta Orsumella – vini Chianti classico"></a>
        </div>
        <p class="cd-footer-contatti">
          ORSUMELLA srl società agricola<br/>
          via Collina, 52 – Montefiridolfi<br/>
          San Casciano Val di Pesa <br/>
          I-50026 Firenze<br/>
          <a href="mailto:info@orsumella.it">info@orsumella.it</a>
        </p>
        <p class="cd-footer-contatti">
          P.IVA/C.F. 06574150485<br>
          REA FI-639323<br>
      ...
      <div class="cd-footer-center">
        <nav class="cd-footer-nav">
          <ul>
            <li><a href="orsumella-vini-chianti-classico-la-tenuta-en.php">Estate</a></li>
            <li><a href="orsumella-vini-chianti-classico-il-territorio-en.php">Territory</a></li>
            <li><a href="index-en.php#vini">Wines</a></li>
            <li><a href="orsumella-vini-chianti-classico-olio-en.php">Olive oil</a></li>
            <li><a href="orsumella-vini-chianti-classico-contatti-en.php">Contacts</a></li>
            <li><a href="orsumella-vini-chianti-classico-news-en.php">News</a></li>
            <li>
              Social&nbsp;
    ...
    <div id="cookieConsent">
      <div class="cookie-left">
        ...
        <a href="#" target="_blank">Informativa</a>.
      </div>
