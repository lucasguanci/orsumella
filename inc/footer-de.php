    ...
    <div class="cd-fixed-bg cd-footer">
      ...
      <div class="cd-footer-center">
        <nav class="cd-footer-nav">
          <ul>
            <li><a href="orsumella-vini-chianti-classico-la-tenuta-de.php">Weingut</a></li>
            <li><a href="orsumella-vini-chianti-classico-il-territorio-de.php">Territory</a></li>
            <li><a href="index-de.php#vini">Weine</a></li>
            <li><a href="orsumella-vini-chianti-classico-olio-de.php">Olivenöl</a></li>
